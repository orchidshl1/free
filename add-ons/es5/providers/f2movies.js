...
var URL = {
    ...
    SEARCH: function SEARCH(title) {
        return 'https://www2.f2movies.to/search/' + title + '.html';
    },
    AJAX_URL: function AJAX_URL(id, server, type) {
        return 'https://www2.f2movies.to/ajax/' + type + '/' + id + '-' + server;
    },
    SERVER_LIST: function SERVER_LIST(id, mid) {
        return 'https://www2.f2movies.to/ajax/v4_movie_episodes/' + id + '/' + mid;
    }
};
