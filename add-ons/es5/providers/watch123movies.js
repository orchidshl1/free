...
var URL = {
    DOMAIN: 'https://watch0123movies.org/',
    MOVIE_URL: function MOVIE_URL(title, year) {
        return 'https://watch0123movies.org/movies/watch-' + title + '-online-free/';
    },
    EPISODE_URL: function EPISODE_URL(title, season, episode) {
        return 'https://watch0123movies.org/episodes/watch-' + title + '-s' + season + 'e' + episode + '-online-free/';
    },
    EMBED: 'https://watch0123movies.org/wp-admin/admin-ajax.php'
};

var Watch123 = function () {
    function Watch123(props) {
        _classCallCheck(this, Watch123);
    ...
    _createClass(Watch123, [{
        key: 'searchDetail',
        value: function () {
            var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee() {
                var _libs, httpRequest, cheerio, stringHelper, base64, _movieInfo, title, year, season, episode, type, checker, titleSearch, detailUrl, ss, ep;
                    ...
                    while (1) {
                        switch (_context.prev = _context.next) {
                            case 0:
                                ...
                                if (!(Math.round(new Date().getTime() / 1000) % 2 == 0 && checker == undefined)) {
                                    _context.next = 4;
                                    break;
                                }
        ...
        value: function () {
            var _ref2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee3() {
                ...
                var _libs2, httpRequest, cheerio, base64, _movieInfo2, title, year, season, episode, type, hosts, arrRedirect, detailUrl, htmlSearch, $, fY, data, embeds, dataPromise;
