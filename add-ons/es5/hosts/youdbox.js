...
var Youdbox = function () {
    function Youdbox(props) {
        _classCallCheck(this, Youdbox);
                    ...
                    while (1) {
                        switch (_context2.prev = _context2.next) {
                            ...
                            case 2:
                                ...
                                url = splitUrl[0] + '//' + splitUrl[2] + '/embed-' + splitUrl[3] + '.html';
                                console.log("🚀 ~ file: youdbox.js ~ line 32 ~ Youdbox ~ getLink ~ url", url);
...
thisSource.function = function (libs, settings) {
    return new Youdbox({ libs: libs, settings: settings });
};