...
var Embedsito = function () {
    function Embedsito(props) {
        _classCallCheck(this, Embedsito);
                    ...
                    while (1) {
                        switch (_context3.prev = _context3.next) {
                            case 0:
                                ...
                                s = url.split('/');
                                id = s[4].split('?')[0];
                                u = 'https://embedsito.com/api/source/' + id;
                                _context3.next = 8;
