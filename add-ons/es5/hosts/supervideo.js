...
var Supervideo = function () {
    function Supervideo(props) {
        _classCallCheck(this, Supervideo);
...
thisSource.function = function (libs, settings) {
    return new Supervideo({ libs: libs, settings: settings });
};