...
var Wolfstream = function () {
    function Wolfstream(props) {
        _classCallCheck(this, Wolfstream);
...
thisSource.function = function (libs, settings) {
    return new Wolfstream({ libs: libs, settings: settings });
};